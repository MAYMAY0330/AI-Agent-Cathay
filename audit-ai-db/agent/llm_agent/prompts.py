...
def build_evidence_judge_prompt(question: str, bundle: EvidenceBundle) -> str:
    return "\n".join(
        [
            ...
            "- direct_answer: 1 only if the source directly answers the user's question.",
            ...
            "- strong: score 6-7 and direct_answer=1.",
            "- supporting: score 4-5, or score 6-7 but direct_answer=0.",
            "- background: score 2-3.",
            ...
            '  "refined_query": "",',
            '  "judgments": [',
            '    {"label": "S1", "checklist": {"direct_answer": 1, "key_concepts": 1, "concrete_rule": 1, "citation_metadata": 1, "authoritative_source": 1, "current_source": 1, "no_obvious_mismatch": 1}, "classification": "strong", "reason": "直接說明資料共享告知義務。", "supporting_quote": "資料共享運用範圍應載明於客戶已簽署之契據文件及官網個資應告知事項。"}',
            "  ]",
            "}",
            "",
            ...
            '  "judgments": [',
            '    {"label": "S1", "checklist": {"direct_answer": 0, "key_concepts": 0, "concrete_rule": 1, "citation_metadata": 1, "authoritative_source": 1, "current_source": 1, "no_obvious_mismatch": 0}, "classification": "background", "reason": "來源談 AI 揭露，與資料共享告知不同。", "supporting_quote": ""}',
            "  ]",
            "}",
            "",
            "# Current Input",
